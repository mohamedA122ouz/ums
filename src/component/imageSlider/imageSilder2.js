                        ...
                        {imageArray.map((el, i) => {
                            return <div key={"div" + i} className={"imgContainer IMG_" + i} >
                                <span>
                                    ...
                                    <p>{smallText[i]}</p>
                                    {console.log(i, i !== 1 && i !== 0 ? "orange" : "blue")}
                                    {i != 2 ? <button className={i > 1 ? "orange" : "blue"}>{buttons[i]}</button> : <button className={i !== 1 && i !== 0 ? "orange" : "blue"}>Login</button>}
                                    {i != 2 ? <button className={i > 1 ? "orange" : "blue"}>{buttons[i + 1]}</button> : ""}
                                </span>
                            </div>
                        })}
                    </div>
